...
import { getPageAccentSafelistTokens } from "./src/dashboard/utils/page-accent.ts";
...
export default defineConfig({
  ...
  shortcuts: {
    "layout-shell":
      "h-dvh overflow-hidden flex flex-col sm:flex-row antialiased font-sans bg-vp-bg text-vp-text",
    "nav-aside":
      "relative shrink-0 border-b border-vp-border bg-[color-mix(in_srgb,var(--vp-surface)_96%,white)] sm:static sm:top-0 sm:h-dvh sm:border-b-0 sm:border-r sm:bg-vp-surface sm:flex sm:flex-col shadow-sm",
    "nav-link":
      "flex items-center justify-center sm:justify-start gap-1.5 sm:gap-3 px-2 py-1.5 sm:px-3.5 sm:py-2.5 rounded-xl text-[12px] font-medium transition-all duration-200",
    "nav-link--idle":
      "text-vp-muted hover:text-vp-text hover:bg-[color-mix(in_srgb,var(--vp-text)_5%,var(--vp-surface))]",
    "nav-link--active":
      "bg-[color-mix(in_srgb,var(--vp-primary)_14%,white)] text-[color-mix(in_srgb,var(--vp-primary)_38%,var(--vp-text))] shadow-[0_4px_14px_color-mix(in_srgb,var(--vp-primary)_14%,transparent),inset_0_1px_0_rgba(255,255,255,0.48)]",
    ...
    "top-tabs-desktop":
      "sticky top-0 z-20 hidden sm:flex items-center gap-1 overflow-x-auto rounded-xl border border-vp-border bg-[color-mix(in_srgb,var(--vp-surface)_92%,white)] p-1 shadow-sm backdrop-blur",
    "top-tab":
      "inline-flex h-9 min-w-0 flex-1 items-center justify-center gap-1.5 rounded-lg px-3 text-xs font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--vp-primary)_35%,transparent)]",
    ...
    "mobile-bottom-bar":
      "fixed inset-x-2 bottom-2 z-30 flex items-center gap-0.5 rounded-[1.2rem] border border-white/55 bg-[linear-gradient(180deg,rgba(255,255,255,0.50)_0%,rgba(255,255,255,0.28)_100%)] p-0.75 shadow-[0_-8px_24px_color-mix(in_srgb,var(--vp-text)_10%,transparent),inset_0_1px_0_rgba(255,255,255,0.45)] backdrop-blur-xl",
    "mobile-bottom-tab":
      "inline-flex h-10 min-w-0 flex-1 shrink-0 flex-col items-center justify-center gap-0.375 rounded-[0.95rem] px-1 text-[11px] font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--vp-primary)_35%,transparent)]",
    "main-canvas": "flex-1 min-h-0 min-w-0 overflow-y-auto bg-vp-bg relative",
    "brand-mark":
